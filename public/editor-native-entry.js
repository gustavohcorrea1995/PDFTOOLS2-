(() => {
  ...
  function addEntry() {
    ...
    style.textContent = `
      ...
      .native-editor-card:after{content:"NOVO MOTOR";position:absolute;right:-34px;top:12px;transform:rotate(35deg);font-size:9px;font-weight:800;letter-spacing:.08em;padding:4px 34px;background:#c1442d;color:#fff}
